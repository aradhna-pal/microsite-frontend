        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">New Enquiry</div>
                    </li>
                </ul>
            </div>
            <!-- new-category -->
            <div class="wg-box">
                <form id="addEnquiryForm" class="form-new-product form-style-1">

                    <fieldset class="name">
                        <div class="body-title">Enquiry Name <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Enquiry name" name="EnquiryName " required>
                    </fieldset>
