        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">All Child category</div>
                    </li>
                </ul>
            </div>
            <!-- all-category -->
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    <div class="wg-filter flex-grow">
                        ...
                        <form class="form-search">
                            ...
                            <div class="button-Childmit">
                                <button class="" type="Childmit"><i class="icon-search"></i></button>
                            </div>
                        </form>
                    </div>
                    <a class="tf-button style-1 w208" href="new-childcategory.php"><i class="icon-plus"></i>Add new</a>
                </div>
                <div class="wg-table table-all-attribute">
                    <ul class="table-title flex gap20 mb-14">
                        ...
                        <li>
                            <div class="body-title">Sub Category Name</div>
                        </li>
                        <li>
                            <div class="body-title">Child Category Name</div>
                        </li>
                    ...
                    <ul class="flex flex-column" id="childCategoryTableBody">
