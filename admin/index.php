                    ...
                    <div class="wg-table table-top-product">
                        <ul class="flex flex-column gap14">
                            ...
                            <li class="product-item">
                                ...
                                <div class="flex items-center justify-between flex-grow">
                                    <div class="name">
                                        <a href="product-list.php" class="body-title-2">Nulo MedalSeries Adult
                                            Cat...</a>
                                        <div class="text-tiny mt-3">100 Items</div>
                                    </div>
                                    <div>
                            ...
                            <li class="product-item">
                                ...
                                <div class="flex items-center justify-between flex-grow">
                                    <div class="name">
                                        <a href="product-list.php" class="body-title-2 mb-3">Pedigree Adult Dry
                                            Dog...</a>
                    ...
                    <div class="wg-table table-product-overview">
                        ...
                        <ul class="flex flex-column gap10">
                            ...
                            <li class="product-item gap14">
                                ...
                                <div class="flex items-center justify-between flex-grow">
                                    <div class="name">
                                        <a href="product-list.php" class="body-text">Taste of the Wild Formula
                                            Finder</a>
                                    </div>
                    ...
                    <ul class="flex flex-column gap20 overflow-h">
                        <li class="comment-item">
                            ...
                            <div class="">
                                ...
                                <div class="text-tiny">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras nec
                                    dolor vel est interdum</div>
                            </div>
                        </li>
                        <li class="comment-item">
                            <div class="image">
                            ...
                            <div class="">
                                ...
                                <div class="text-tiny">Cras nec viverra justo, a mattis lacus. Vestibulum eleifend, leo
                                    sit amet aliquam laoreet, turpis leo vulputate orci</div>
                            </div>
                        </li>
                        <li class="comment-item">
                            <div class="image">
                            ...
                            <div class="">
                                ...
                                <div class="text-tiny">Morbi eget commodo diam. Praesent dignissim purus ac turpis porta
                                </div>
                            </div>
                        </li>
                        <li class="comment-item">
