...
<div class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" id="editCustomerForm">

                    <!-- customer Name -->
                    <fieldset class="name">
                        <div class="body-title">
                            customer name <span class="tf-color-1">*</span>
                        </div>
                        <input class="flex-grow" type="text" placeholder="customer name" name="text" required>
                    </fieldset>
                    ...
                    <fieldset class="category">
                        <div class="body-title">customer Status</div>
